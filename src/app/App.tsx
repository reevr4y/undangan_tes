                ...
                <div className="w-[45%] pr-2">
                  {idx % 2 === 0 ? (
                    ...
                    <div className="text-right">
                      <h4 className="text-xl mb-1 font-medium" style={{ fontFamily: 'Alice, serif', color: '#4A3728' }}>
                        {story.title}
                      </h4>
                      <p className="text-[0.8rem] leading-relaxed" style={{ fontFamily: 'Lora, serif', color: '#6B5339' }}>
                        {story.text}
                      </p>
                    </div>
                  )}
